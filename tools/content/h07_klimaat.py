...
def bouw(p):
    ...
    p.tekst(
        ...
        'fabriek toe aan "energie" of aan "industrie"? Our World in Data zet ongeveer '
        'driekwart van alle broeikasgasuitstoot onder één noemer, '
        '"energiegebruik" — inclusief transport en gebouwen. Andere overzichten '
        'verdelen precies diezelfde uitstoot over vier of vijf sectoren, waardoor '
        'energie ineens een stuk kleiner lijkt.</p>'
